...
CREATE TABLE `message_user` (
  ...
  PRIMARY KEY (`MESS_ID`,`TO_ID`,`FROM_ID`,`DATE`),
  KEY `TO_ID_idx` (`TO_ID`),
  CONSTRAINT `FROM_ID` FOREIGN KEY (`TO_ID`) REFERENCES `user` (`PHONE_NUMBER`),
  CONSTRAINT `MESS_ID` FOREIGN KEY (`MESS_ID`) REFERENCES `message` (`MESSAGE_ID`),
  CONSTRAINT `TO_ID` FOREIGN KEY (`TO_ID`) REFERENCES `user` (`PHONE_NUMBER`)
